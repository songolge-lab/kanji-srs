...
great_job:'Great job!',done_cards_label:'cards studied',done_streak_label:'day streak',swipe_hint:'Swipe the card or tap a button to grade',srs_haptics:'Haptic feedback',srs_haptics_hint:'Vibrate on flips & swipes',info_haptics:'Plays a subtle vibration when you flip a card or swipe to grade it. Works on devices that support vibration (most Android phones); silently ignored elsewhere.',
...
search_placeholder:'Search across all decks…',search_placeholder_deck:'Search in this deck…',search_in_deck:'Search in this deck',search_filter_all:'All Fields',search_filter_kanji:'Kanji / Word',search_filter_meaning:'Meaning',search_filter_example:'Examples',search_no_results:'No cards found.',search_empty_state:'Type to search across all decks…',search_empty_state_deck:'Type to search in this deck…',search_found:'Found {count} cards',
...
great_job:'Harika iş!',done_cards_label:'kart çalışıldı',done_streak_label:'günlük seri',swipe_hint:'Notlamak için kartı kaydır ya da bir butona dokun',srs_haptics:'Titreşim geri bildirimi',srs_haptics_hint:'Çevirme ve kaydırmada titreşim',info_haptics:'Bir kartı çevirdiğinde veya notlamak için kaydırdığında hafif bir titreşim verir. Titreşimi destekleyen cihazlarda (çoğu Android telefon) çalışır; diğerlerinde sessizce yok sayılır.',
...
search_placeholder:'Tüm destelerde ara…',search_placeholder_deck:'Bu destede ara…',search_in_deck:'Bu destede ara',search_filter_all:'Tüm Alanlar',search_filter_kanji:'Kanji / Kelime',search_filter_meaning:'Anlam',search_filter_example:'Örnekler',search_no_results:'Kart bulunamadı.',search_empty_state:'Tüm destelerde aramak için yaz…',search_empty_state_deck:'Bu destede aramak için yaz…',search_found:'{count} kart bulundu',
...
search_placeholder:'모든 덱에서 검색…',search_placeholder_deck:'이 덱에서 검색…',search_in_deck:'이 덱에서 검색',search_filter_all:'전체',search_filter_kanji:'한자 / 단어',search_filter_meaning:'의미',search_filter_example:'예문',search_no_results:'카드를 찾을 수 없습니다.',search_empty_state:'모든 덱에서 검색하려면 입력하세요…',search_empty_state_deck:'이 덱에서 검색하려면 입력하세요…',search_found:'{count}장 발견',
...
search_placeholder:'Бүх багцаас хайх…',search_placeholder_deck:'Энэ багцаас хайх…',search_in_deck:'Энэ багцаас хайх',search_filter_all:'Бүх талбар',search_filter_kanji:'Ханз / Үг',search_filter_meaning:'Утга',search_filter_example:'Жишээ',search_no_results:'Карт олдсонгүй.',search_empty_state:'Бүх багцаас хайхын тулд бичнэ үү…',search_empty_state_deck:'Энэ багцаас хайхын тулд бичнэ үү…',search_found:'{count} карт олдлоо',
...
function showView(name) {
  ...
  // Compact deck-list search çubuğu artık nav dışı — her showView çağrısında
  // kapat (dil değişimi de showView(currentView) tetikler; açık kalırsa eski
  // dilde render edilmiş placeholder/filtre metni yeni dile geçmezdi).
  DeckList.closeDeckSearch();
...
document.getElementById('btn-toggle-deck-search').addEventListener('click', DeckList.toggleDeckSearch);
...
Object.assign(window, {
  ...
  toggleDeckScopedSearch: DeckList.toggleDeckScopedSearch,
...
// Hook app.save to refresh any open inline search bars (Decks header / deck-scoped)
