...
incl_subdecks:' (incl. sub-decks)',cancel:'Cancel',close:'Close',kanji_detail:'Kanji Detail',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'No detail available for this character yet.',no_cards_scope:'No cards in this scope',
...
incl_subdecks:' (alt desteler dahil)',cancel:'İptal',close:'Kapat',kanji_detail:'Kanji Detayı',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'Bu karakter için henüz detay yok.',no_cards_scope:'Bu kapsamda kart yok',
...
function setLang(lang) { currentLang = lang; localStorage.setItem('stacks-lang', lang); updateExampleDeck(); updateStaticTexts(); showView(currentView); Analytics.renderGlobalStats(); }
...
Object.assign(window, {
  ...
  toggleSettingInfo: Settings.toggleSettingInfo, saveSettings: Settings.saveSettings,
