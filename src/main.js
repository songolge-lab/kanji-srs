...
deck_meta:'{total} cards · {mastered} mastered',sub_decks_count:'{count} sub-decks',
...
incl_subdecks:' (incl. sub-decks)',cancel:'Cancel',close:'Close',kanji_detail:'Kanji Detail',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'No detail available for this character yet.',kanji_meaning_en:'Meaning (En)',no_cards_scope:'No cards in this scope',
...
furigana_label:'Furigana (reading)',furigana_placeholder:'e.g. かんじ',
...
bulk_format:'Format: Kanji | Furigana | Meaning | Example JP (opt) | Example TR (opt)',
...
furigana_searching:'Searching reading…',furigana_not_found:'Auto reading not found, you can type manually',
furigana_editor_hint:'Tap the kanji/word you want to add furigana to.',
furigana_word_not_found:'Auto reading not found for "{word}", split into individual kanji — pick one.',
furigana_manual_label:'reading for (type manually)',
...
warn_required:'⚠ Kanji, furigana and meaning are required',warn_deck_not_found:'⚠ Deck not found',
...
deck_meta:'{total} kart · {mastered} ustalaşıldı',sub_decks_count:'{count} alt deste',
...
incl_subdecks:' (alt desteler dahil)',cancel:'İptal',close:'Kapat',kanji_detail:'Kanji Detayı',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'Bu karakter için henüz detay yok.',kanji_meaning_en:'Anlam (En)',no_cards_scope:'Bu kapsamda kart yok',
...
kanji_label:'Kanji / Kelime',kanji_placeholder:'例: 漢字',furigana_label:'Furigana (okunuş)',furigana_placeholder:'例: かんじ',
...
bulk_format:'Format: Kanji | Furigana | Anlam | Örnek JP (opsiyonel) | Örnek TR (opsiyonel)',
...
furigana_searching:'Okunuş aranıyor…',furigana_not_found:'Otomatik okunuş bulunamadı, elle yazabilirsin',
furigana_editor_hint:'Furigana eklemek istediğin kanjiye/kelimeye dokun.',
furigana_word_not_found:'"{word}" için otomatik okunuş bulunamadı, kelimeyi tek tek kanjiye böldüm — birini seç.',
furigana_manual_label:'için okunuş (elle yaz)',
...
warn_required:'⚠ Kanji, furigana ve anlam zorunlu',warn_deck_not_found:'⚠ Deste bulunamadı',
...
function setLang(lang) { currentLang = lang; localStorage.setItem('stacks-lang', lang); KanjiDict.setLanguage(lang); updateExampleDeck(); updateStaticTexts(); showView(currentView); Analytics.renderGlobalStats(); }
...
// ─── MODAL ───────────────────────────────────────────────────────────
function openModal(title, bodyHTML) { document.getElementById('modal-title').textContent = title; document.getElementById('modal-body').innerHTML = bodyHTML; document.getElementById('modal-bg').classList.add('show'); }
...
app.renderHeatmap = Analytics.renderHeatmap;
...
Object.assign(window, {
  ...
  changeCalendarMonth: Analytics.changeCalendarMonth,
  ...
  communityDownload: CommunityHub.downloadDeck, communityRefresh: CommunityHub.refresh,
