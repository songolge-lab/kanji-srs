...
incl_subdecks:' (alt desteler dahil)',cancel:'İptal',close:'Kapat',kanji_detail:'Kanji Detayı',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'Bu karakter için henüz detay yok.',kanji_meaning_en:'Anlam (En)',msg_ai_key_missing:'Lütfen önce Ayarlar\'dan Gemini API Anahtarınızı yapılandırın.',msg_ai_loading:'Düşünüyor...',word_detail_title:'Kelime Detayı',word_ai_meaning:'🧠 Bağlamsal Anlam',word_kanji_breakdown:'Kanji Ayrıntısı',btn_ai_deck:'✨ Yapay Zekâ Destesi',modal_ai_deck_title:'Yapay Zekâ Destesi Oluştur',ai_deck_placeholder:'ör. JLPT N4 Seyahat Fiilleri',ai_generating:'Oluşturuluyor...',toast_ai_deck_success:'{count} kartlık yapay zekâ destesi oluşturuldu! ✨',no_cards_scope:'Bu kapsamda kart yok',
