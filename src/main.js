...
incl_subdecks:' (incl. sub-decks)',cancel:'Cancel',close:'Close',kanji_detail:'Kanji Detail',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'No detail available for this character yet.',kanji_meaning_en:'Meaning (En)',btn_ai_story:'🧠 Generate AI Story',msg_ai_key_missing:'Please configure your Gemini API Key in Settings first.',msg_ai_loading:'Thinking...',btn_ai_deck:'✨ AI Deck',modal_ai_deck_title:'Generate AI Deck',ai_deck_placeholder:'e.g., JLPT N4 Travel Verbs',ai_generating:'Generating...',toast_ai_deck_success:'AI deck created with {count} cards! ✨',no_cards_scope:'No cards in this scope',
...
incl_subdecks:' (alt desteler dahil)',cancel:'İptal',close:'Kapat',kanji_detail:'Kanji Detayı',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'Bu karakter için henüz detay yok.',kanji_meaning_en:'Anlam (En)',btn_ai_story:'🧠 Yapay Zekâ Hikâyesi Oluştur',msg_ai_key_missing:'Lütfen önce Ayarlar\'dan Gemini API Anahtarınızı yapılandırın.',msg_ai_loading:'Düşünüyor...',btn_ai_deck:'✨ Yapay Zekâ Destesi',modal_ai_deck_title:'Yapay Zekâ Destesi Oluştur',ai_deck_placeholder:'ör. JLPT N4 Seyahat Fiilleri',ai_generating:'Oluşturuluyor...',toast_ai_deck_success:'{count} kartlık yapay zekâ destesi oluşturuldu! ✨',no_cards_scope:'Bu kapsamda kart yok',
