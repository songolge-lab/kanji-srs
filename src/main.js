...
incl_subdecks:' (incl. sub-decks)',cancel:'Cancel',close:'Close',kanji_detail:'Kanji Detail',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'No detail available for this character yet.',kanji_meaning_en:'Meaning (En)',btn_ai_story:'🧠 Generate AI Story',msg_ai_key_missing:'Please configure your Gemini API Key in Settings first.',msg_ai_loading:'Thinking...',no_cards_scope:'No cards in this scope',
...
bulk_format:'Format: Word | Meaning OR Word | Furigana | Meaning | Example JP (opt) | Example TR (opt)',
...
incl_subdecks:' (alt desteler dahil)',cancel:'İptal',close:'Kapat',kanji_detail:'Kanji Detayı',kanji_onyomi:'On\'yomi',kanji_kunyomi:'Kun\'yomi',kanji_not_found:'Bu karakter için henüz detay yok.',kanji_meaning_en:'Anlam (En)',btn_ai_story:'🧠 Yapay Zekâ Hikâyesi Oluştur',msg_ai_key_missing:'Lütfen önce Ayarlar\'dan Gemini API Anahtarınızı yapılandırın.',msg_ai_loading:'Düşünüyor...',no_cards_scope:'Bu kapsamda kart yok',
...
bulk_format:'Format: Kelime | Anlam VEYA Kelime | Furigana | Anlam | Örnek JP (ops) | Örnek TR (ops)',
